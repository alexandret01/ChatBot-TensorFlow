...
# Criando Dicionario para Linhas
...
# Criando Dicionario para Conversas
        
        
conversas_id= []
for conversa in conversas[:-1]:
    _conversa = conversa.split(' +++$+++')[-1].replace("'", "").replace(" ", "")
    _conversa = _conversa[1:-1]
    conversas_id.append(_conversa.split(','))
    
# Separando pergutnas e respostas
...
# Adicionando Tokens no Dicionarios
...
# Ordenação das perguntas e respostas
